...
class PublicAuthController extends AbstractController
{
    #[Route("/public/register", name: "public_register", methods: ["POST"])]
    ...
    #[Route("/public/login", name: "public_login", methods: ["POST"])]
